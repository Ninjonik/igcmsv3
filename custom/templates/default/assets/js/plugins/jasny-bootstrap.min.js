...
!(function (u) {
  ...
  var i = "Microsoft Internet Explorer" == window.navigator.appName,
    n = function (e, t) {
      if (
        ((this.$element = u(e)),
        (this.options = u.extend({}, n.DEFAULTS, t)),
        (this.$input = this.$element.find(":file")),
        0 !== this.$input.length)
      ) {
        (this.name = this.$input.attr("name") || t.name),
          (this.$hidden = this.$element.find(
            'input[type=hidden][name="' + this.name + '"]'
          )),
          0 === this.$hidden.length &&
            (this.$hidden = u('<input type="hidden">').insertBefore(
              this.$input
            )),
  ...
  (n.DEFAULTS = { clearName: !0 }),
    (n.prototype.listen = function () {
      this.$input.on("change.bs.fileinput", u.proxy(this.change, this)),
        u(this.$input[0].form).on(
          "reset.bs.fileinput",
          u.proxy(this.reset, this)
        ),
        this.$element
          .find('[data-trigger="fileinput"]')
          .on("click.bs.fileinput", u.proxy(this.trigger, this)),
        this.$element
          .find('[data-dismiss="fileinput"]')
          .on("click.bs.fileinput", u.proxy(this.clear, this));
    }),
    ...
    (n.prototype.change = function (e) {
      var l =
        void 0 === e.target.files
          ? e.target && e.target.value
            ...
            : []
          : e.target.files;
      if ((e.stopPropagation(), 0 === l.length))
        return this.clear(), void this.$element.trigger("clear.bs.fileinput");
      if (!this.verifySizes(l))
        return (
      ...
      var h = l[0];
      if (
        0 < this.$preview.length &&
        (void 0 !== h.type
          ? h.type.match(/^image\/(gif|png|jpeg|svg\+xml)$/)
          : h.name.match(/\.(gif|png|jpe?g|svg)$/i)) &&
        ...
        (t.onload = function (e) {
          ...
          if (
            ...
            o.find(".fileinput-filename").text(h.name),
          ...
          f.html(t),
            p.options.exif && p.setImageTransform(t, h),
            o.addClass("fileinput-exists").removeClass("fileinput-new"),
            o.trigger("change.bs.fileinput", l);
        }),
          t.readAsDataURL(h);
      } else {
        var i = h.name,
    ...
    (n.prototype.getImageExif = function (e) {
      ...
      for (var t = e.byteLength, i = 2; i < t; ) {
        ...
        if (((i += 2), 65505 == n)) {
          ...
          i += 2;
          for (var a = 0; a < r; a++)
            if (274 == e.getUint16(i + 12 * a, s))
              return e.getUint16(i + 12 * a + 8, s);
        } else {
  ...
  (u.fn.fileinput = function (i) {
    return this.each(function () {
      ...
      t || e.data("bs.fileinput", (t = new n(this, i))),
        "string" == typeof i && t[i]();
    });
  }),
    (u.fn.fileinput.Constructor = n),
    (u.fn.fileinput.noConflict = function () {
