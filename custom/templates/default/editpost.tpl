      ...
      <div class="container">
         <div class="row">
            <div class="col-md-8 ml-auto mr-auto text-center">
               <h2 class="title">Upraviť Článok</h2>
            </div>
         </div>
      </div>
   </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 ...
                                 <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Maximálne 25 znakov" aria-label="First Name..." maxlength="25" name="title" value="{$dataform['title']}">
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group">
                                       <select class="selectpicker" data-size="7" data-style="btn btn-primary btn-simple" title="Single Select" name="category">
                                          ...
                                          <option selected value="{$dataform['catID']}">{$dataform['name']}</option>
                           ...
                           <div class="form-group" id="file-uploader" align="left">
                              ...
                              <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                 <div class="fileinput-new thumbnail">
                                    <img src="../../uploads/backgrounds/{$dataform['background']}" alt="...">
                                 </div>
