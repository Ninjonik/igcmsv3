      ...
      <div class="content">
        <div class="row">
          ...
          <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Vytvoriť stránku</h4>
                      </div>
                      <div class="card-body">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <div class="form-group">
                                <input type="text" class="form-control" name="redirect"> Presmerovanie stránky, ak nie je nie nič vyplnené, tak presmerovanie nebude. (používať iba v prípade, že sa chce odkázať na iný web atp.)
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <div class="form-group">
                                <input type="text" class="form-control" name="icon"> Príklad: icon-pencil
                              </div>
                            </div>
                          </div>
                          <div class="row">
