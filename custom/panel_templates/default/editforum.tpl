                      ...
                      <div class="row justify-content-center mt-5">
                        <div class="col-sm-10">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Názov fóra" value="{$forum['title']}" required>
                          </div>
                        </div>
                        <div class="col-sm-10">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="desc" class="form-control" placeholder="Popis fóra" value="{$forum['desc']}">
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row justify-content-center mt-5">
                        <div class="col-sm-10">
                          ...
                          <div class="input-group">
                            ...
                            <input type="input" name="icon" class="form-control" placeholder="Ikona fóra" value="{$forum['icon']}">
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row justify-content-center">
                        ...
                        <div class="form-check">
                          <select class="selectpicker" data-size="7" data-style="btn btn-primary" name="parent">
                            ...
                            <option value={$forum['parent']} selected>{$parentsmarty['title']}</option>
                            {foreach from=$forums3 item=$forums4}

                                <option value="{$forums4['id']}">{$forums4["title"]}</option>
                        ...
                        <div class="form-check">
                            <input type="number" name="order" class="form-control" placeholder="Poradie fóra" min="0" value="{$forum['order']}">
                        </div>
                      </div>
                    </div>
                  </div>
