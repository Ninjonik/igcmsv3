                  ...
                  <div class="tab-content">
                      ...
                      <div class="row justify-content-center mt-5">
                        <div class="col-sm-10">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="html" class="form-control" placeholder="HTML skupiny">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="tab-pane" id="address">
                      <div class="row justify-content-center">
                        ...
                        <div class="card-body">
                        {foreach $permdata item=$finalizeddata}
                        <div class="form-check">
                          <label class="form-check-label">
                              <input class="form-check-input" type="checkbox" value="{$finalizeddata['id']}" name="{$finalizeddata['id']}">
                              {$finalizeddata["name"]}
