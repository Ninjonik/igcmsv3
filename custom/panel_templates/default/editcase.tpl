                      ...
                      <div class="row justify-content-center mt-5">
                        <div class="col-sm-10">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Názov Bedne" value="{$item['title']}">
                          </div>
                        </div>
                        <div class="col-sm-10">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="desc" class="form-control" placeholder="Krátky popis Bedne" value="{$item['desc']}">
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row justify-content-center mt-5">
                        <div class="col-sm-10">
                          ...
                          <div class="input-group">
                            ...
                            <input type="number" name="value" class="form-control" placeholder="Cena" value="{$item['price']}">
                          </div>
                        </div>
                      </div>
                    </div>
