 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/af-2.3.3/b-1.5.6/b-colvis-1.5.6/cr-1.5.0/fc-3.2.5/fh-3.1.4/kt-2.5.0/r-2.2.2/rg-1.1.0/rr-1.2.4/sc-2.0.0/sl-1.3.0
 *
 * Included libraries:
...
(function (h) {
  ...
  n.ext = x = {
    ...
    classes: {},
    build:
      "bs4/dt-1.10.18/af-2.3.3/b-1.5.6/b-colvis-1.5.6/cr-1.5.0/fc-3.2.5/fh-3.1.4/kt-2.5.0/r-2.2.2/rg-1.1.0/rr-1.2.4/sc-2.0.0/sl-1.3.0",
    errMode: "alert",
    feature: [],
    search: [],
...
$jscomp.defineProperty =
  $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties
    ...
    : function (b, g, h) {
        b != Array.prototype && b != Object.prototype && (b[g] = h.value);
      };
...
$jscomp.polyfill = function (b, g, h, m) {
  if (g) {
    h = $jscomp.global;
    b = b.split(".");
...
(function (b) {
  ...
  var l = b.fn.dataTable,
    ...
    k = function (a, d) {
      ...
      this.c = b.extend(!0, {}, l.defaults.autoFill, k.defaults, d);
      this.s = {
        dt: new l.Api(a),
  ...
  b.extend(k.prototype, {
    ...
    _actionSelector: function (a) {
      ...
      if (1 === e.length && !1 === this.c.alwaysAsk) {
        var p = f[e[0]].execute(c, a);
        this._update(p, a);
      } else {
        var n = this.dom.list.children("ul").empty();
        e.push("cancel");
        b.each(e, function (e, p) {
          n.append(
            b("<li/>")
              .append(
              ...
              .append(
                b('<div class="dt-autofill-button">').append(
                  b(
                    ...
                    var e = f[p].execute(c, a, b(this).closest("li"));
                    d._update(e, a);
    ...
    _drawSelection: function (a, d) {
      ...
      var p = c.row(":eq(" + e.row + ")", { page: "current" });
      p = b(c.cell(p.index(), a).node());
      if (
        c.cell(p).any() &&
        ...
        this.s.end = e;
        c = d.row < e.row ? f : p;
        var n = d.row < e.row ? p : f;
        a = d.column < e.column ? f : p;
        f = d.column < e.column ? p : f;
        c = this._getPosition(c.get(0)).top;
        a = this._getPosition(a.get(0)).left;
        d = this._getPosition(n.get(0)).top + n.outerHeight() - c;
        f = this._getPosition(f.get(0)).left + f.outerWidth() - a;
        e = this.dom.select;
        e.top.css({ top: c, left: a, width: f });
        e.left.css({ top: c, left: a, height: d });
        e.bottom.css({ top: c + d, left: a, width: f });
        e.right.css({ top: c, left: a + f, height: d });
      }
    },
    _editor: function (a) {
      var d = this.s.dt,
      ...
      if (c) {
        for (
          var b = {}, e = [], p = c.fields(), n = 0, h = a.length;
          n < h;
          n++
        )
          for (var g = 0, l = a[n].length; g < l; g++) {
            var q = a[n][g],
              t = d.settings()[0].aoColumns[q.index.column],
              k = t.editField;
            if (k === m) {
              t = t.mData;
      ...
      var a = this,
        ...
        f =
          null !== this.c.focus
            ...
            : "hover";
      if ("focus" === f)
        d.on("key-focus.autoFill", function (c, d, b) {
          a._attach(b.node());
        ...
        b(d.table().body()).on("click" + c, "td, th", function (c) {
          ...
          b(h.body).on("click" + c, function (c) {
    ...
    _getPosition: function (a, d) {
      ...
      do {
        var e = a.offsetTop,
          h = a.offsetLeft;
        var g = b(a.offsetParent);
        c += e + g.scrollTop();
        f += h + g.scrollLeft();
        c += 1 * parseInt(g.css("margin-top"));
        c += 1 * parseInt(g.css("border-top-width"));
        if ("body" === a.nodeName.toLowerCase()) break;
        a = g.get(0);
      } while (g.get(0) !== d.get(0));
      return { top: c, left: f };
    },
    ...
    _mouseup: function (a) {
      ...
      f = this.s.start;
      var e = this.s.end;
      if (f.row !== e.row || f.column !== e.column) {
        var g = c.cell(":eq(" + f.row + ")", f.column + ":visible", {
          page: "current",
        });
        if (b("div.DTE", g.node()).length) {
          var n = c.editor();
          ...
          var k = this._range(f.row, e.row);
          f = this._range(f.column, e.column);
          e = [];
          for (
            var l = c.settings()[0], r = l.aoColumns, q = 0;
            q < k.length;
            q++
          )
            e.push(
              b.map(f, function (a) {
                var d = c.row(":eq(" + k[q] + ")", { page: "current" });
                a = c.cell(d.index(), a + ":visible");
                d = a.data();
                var b = a.index(),
                  f = r[b.column].editField;
                f !== m &&
                  (d = l.oApi._fnGetObjectDataFn(f)(c.row(b.row).data()));
                return { cell: a, data: d, label: a.data(), index: b };
              })
            );
    ...
    _range: function (a, d) {
      var c = [];
      if (a <= d) for (; a <= d; a++) c.push(a);
      else for (; a >= d; a--) c.push(a);
      return c;
    },
    _shiftScroll: function (a) {
      var d = this,
        c = this.s.scroll,
        b = !1,
        e = a.pageY - h.body.scrollTop,
        g = a.pageX - h.body.scrollLeft,
        n,
        k,
        l,
        m;
      65 > e ? (n = -5) : e > c.windowHeight - 65 && (n = 5);
      65 > g ? (k = -5) : g > c.windowWidth - 65 && (k = 5);
      null !== c.dtTop && a.pageY < c.dtTop + 65
        ? (l = -5)
        : null !== c.dtTop && a.pageY > c.dtTop + c.dtHeight - 65 && (l = 5);
      null !== c.dtLeft && a.pageX < c.dtLeft + 65
        ? (m = -5)
        : null !== c.dtLeft && a.pageX > c.dtLeft + c.dtWidth - 65 && (m = 5);
      n || k || l || m
        ? ((c.windowVert = n),
          (c.windowHoriz = k),
          (c.dtVert = l),
      ...
      !this.s.scrollInterval &&
        ...
        (this.s.scrollInterval = setInterval(function () {
          c.windowVert && (h.body.scrollTop += c.windowVert);
          c.windowHoriz && (h.body.scrollLeft += c.windowHoriz);
      ...
      if (!1 !== a) {
        ...
        if (null !== this.c.update ? this.c.update : !this.c.editor) {
          for (var b = 0, e = d.length; b < e; b++)
            for (var g = 0, h = d[b].length; g < h; g++) {
              var k = d[b][g];
    ...
    increment: {
      ...
      execute: function (a, d, c) {
        ...
        for (var f = 0, e = d.length; f < e; f++)
          for (var g = 0, h = d[f].length; g < h; g++)
            (d[f][g].set = a), (a += c);
      },
    },
    fill: {
      ...
      execute: function (a, b, c) {
        ...
        for (var d = b.length; c < d; c++)
          for (var e = 0, g = b[c].length; e < g; e++) b[c][e].set = a;
      },
    },
    fillHorizontal: {
      available: function (a, b) {
  ...
  k.classes = { btn: "btn" };
  var r = b.fn.dataTable.Api;
  r.register("autoFill()", function () {
    return this;
  });
  r.register("autoFill().enabled()", function () {
    var a = this.context[0];
    return a.autoFill ? a.autoFill.enabled() : !1;
  });
  r.register("autoFill().enable()", function (a) {
    return this.iterator("table", function (b) {
      b.autoFill && b.autoFill.enable(a);
    });
  });
  r.register("autoFill().disable()", function () {
    return this.iterator("table", function (a) {
      a.autoFill && a.autoFill.disable();
    });
  });
  b(h).on("preInit.dt.autofill", function (a, d, c) {
    "dt" === a.namespace &&
      ((a = d.oInit.autoFill), (c = l.defaults.autoFill), a || c) &&
      ((c = b.extend({}, a, c)), !1 !== a && new k(d, c));
  });
  l.AutoFill = k;
  return (l.AutoFill = k);
});
...
(function (b) {
  ...
  var l = b.fn.dataTable,
    p = function (a, c) {
      ...
      this.c = b.extend(!0, {}, l.defaults.keyTable, p.defaults, c);
      this.s = {
        dt: new l.Api(a),
        enable: !0,
        focusDraw: !1,
  ...
  b.extend(p.prototype, {
    ...
    _constructor: function () {
      ...
      if (this.c.blurable)
        b(e).on("mousedown.keyTable", function (d) {
          b(d.target).parents(".dataTables_filter").length && a._blur();
          b(d.target).parents().filter(c.table().container()).length ||
            b(d.target).parents("div.DTE").length ||
            b(d.target).parents("div.editor-datetime").length ||
            b(d.target).parents().filter(".DTFC_Cloned").length ||
            a._blur();
        });
      if (this.c.editor) {
        var k = this.c.editor;
        ...
        b(c.table().body()).on("dblclick.keyTable", "th, td", function (b) {
          !1 !== a.s.enable && c.cell(this).any() && a._editor(null, b, !0);
        });
      }
      if (c.settings()[0].oFeatures.bStateSave)
        c.on("stateSaveParams.keyTable", function (b, c, d) {
        ...
        if (!a.s.focusDraw) {
          ...
          if (f && f.node && b(f.node).closest("body") === e.body) {
            ...
            var k = c.page.info(),
              m = f.row + k.start;
            0 !== k.recordsDisplay &&
              (m >= k.recordsDisplay && (m = k.recordsDisplay - 1),
              a._focus(m, f.column, !0, d));
          }
        }
      });
    ...
    _clipboard: function () {
      var a = this.s.dt,
        c = this;
      g.getSelection &&
        (b(e).on("copy.keyTable", function (a) {
          a = a.originalEvent;
          ...
          !b &&
            ...
            (a.clipboardData.setData(
              "text/plain",
              d.cell.render(c.c.clipboardOrthogonal)
            ),
            a.preventDefault());
        }),
        b(e).on("paste.keyTable", function (b) {
          ...
          var d = c.s.lastFocus,
            ...
            h;
          !d ||
            (f && "body" !== f.nodeName.toLowerCase()) ||
            (b.preventDefault(),
            g.clipboardData && g.clipboardData.getData
              ? (h = g.clipboardData.getData("Text"))
              : b.clipboardData &&
                b.clipboardData.getData &&
                (h = b.clipboardData.getData("text/plain")),
            m
              ? m.inline(d.cell.index()).set(m.displayed()[0], h).submit()
    ...
    _focus: function (a, c, d, k) {
      ...
      if (this.s.enable) {
        ...
        if (-1 !== h.length && (a < h.start || a >= h.start + h.length))
          ...
          if (d === n || !0 === d)
            this._scroll(b(g), b(e.body), q, "offset"),
              (d = m.table().body().parentNode),
              d !== m.table().header().parentNode &&
                ((d = b(d.parentNode)), this._scroll(d, d, q, "position"));
          this.s.lastFocus = {
            cell: h,
            node: h.node(),
            relative: {
            ...
            switch (a.keyCode) {
              ...
              case 34:
                d &&
                  !f &&
                  (a.preventDefault(),
                  k.page(33 === a.keyCode ? "previous" : "next").draw(!1));
                break;
              case 35:
              case 36:
                d &&
                  (a.preventDefault(),
                  (c = k.cells({ page: "current" }).indexes()),
                  (d = this._columns()),
                  this._focus(
                    k.cell(c[35 === a.keyCode ? c.length - 1 : d[0]]),
                    null,
                    !0,
                    a
                  ));
    ...
    _shift: function (a, c, d) {
      ...
      if (h) {
        ...
        "right" === c
          ...
          ? l--
          : "down" === c && l++;
        0 <= l && l < g && -1 !== b.inArray(f, e)
          ? (a.preventDefault(), this._focus(l, f, !0, a))
          : d && this.c.blurable
          ? this._blur()
          : a.preventDefault();
      }
    ...
    _tabInput: function () {
      ...
      if (-1 != d)
        b('<div><input type="text" tabindex="' + d + '"/></div>')
          .css({
            position: "absolute",
            height: 1,
            width: 0,
          ...
          .insertBefore(c.table().node())
          .children()
          .on("focus", function (b) {
            c.cell(":eq(0)", { page: "current" }).any() &&
              a._focus(
                c.cell(":eq(0)", "0:visible", { page: "current" }),
                null,
                !0,
                b
              );
  ...
  b(e).on("preInit.dt.dtk", function (a, c, d) {
    "dt" === a.namespace &&
      ((a = c.oInit.keys), (d = l.defaults.keys), a || d) &&
...
(function (d) {
    ...
    g = function (a, b) {
      this instanceof g
        ? (b === n && (b = {}),
          ...
          (this.s = d.extend(this.s, g.oDefaults, b)),
  ...
  d.extend(g.prototype, {
    measure: function (a) {
      ...
      b.row &&
        ((b.viewport = d.contains(k, this.dom.scroller)
          ? this.dom.scroller.clientHeight
          : this._parseHeight(d(this.dom.scroller).css("height"))),
        b.viewport ||
    ...
    scrollToRow: function (a, b) {
      ...
      "undefined" == typeof b || b
        ? ((this.s.ani = e),
          d(this.dom.scroller).animate({ scrollTop: f }, function () {
            setTimeout(function () {
              c.s.ani = !1;
            }, 25);
          }))
        : d(this.dom.scroller).scrollTop(f);
    },
    construct: function () {
      var a = this,
        b = this.s.dtApi;
      if (this.s.dt.oFeatures.bPaginate) {
        ...
        this.s.loadingIndicator &&
          ...
          d(this.dom.scroller.parentNode)
        ...
        d(this.dom.scroller).on("scroll.dt-scroller", function (b) {
          a._scroll.call(a);
        });
        ...
        d(h).on("resize.dt-scroller", function () {
          a.measure(!1);
          a._info();
        });
        var c = !0,
          e = b.state.loaded();
        b.on("stateSaveParams.scroller", function (b, d, h) {
          h.scroller = {
            topRow: c && e && e.scroller ? e.scroller.topRow : a.s.topRowFloat,
    ...
    _calcRowHeight: function () {
      ...
      else for (; 3 > m; m++) e.append("<tr><td>&#160;</td></tr>");
      d("div." + a.oClasses.sScrollBody, f).append(c);
    ...
    _draw: function () {
      ...
      c =
        "jump" === this.scrollType
          ? this._domain("physicalToVirtual", this.s.topRowFloat * b.row)
          : c;
      d(a.dom.scroller).scrollTop(c);
      this.s.baseScrollTop = c;
      this.s.baseRowTop = this.s.topRowFloat;
      var g = c - (this.s.topRowFloat - f) * b.row;
      0 === f ? (g = 0) : f + m >= h && (g = b.scroll - e);
    ...
    _domain: function (a, b) {
      ...
      if ("virtualToPhysical" === a && b > c.virtual - 1e4)
        return (b = c.virtual - b), c.scroll - b;
      if ("physicalToVirtual" === a && b > c.scroll - 1e4)
        return (b = c.scroll - b), c.virtual - b;
      c =
        (("virtualToPhysical" === a ? c.scroll : c.virtual) - 1e4) /
        (("virtualToPhysical" === a ? c.virtual : c.scroll) - 1e4);
      return c * b + (1e4 - 1e4 * c);
    },
    _info: function () {
      if (this.s.dt.oFeatures.bInfo) {
        var a = this.s.dt,
          ...
          g = a.fnRecordsDisplay();
        c = Math.ceil(
          this.pixelsToRow(c + this.s.heights.viewport, !1, this.s.ani)
        );
        c = g < c ? g : c;
        var h = a.fnFormatNumber(e),
        ...
        h =
          ...
          a.fnRecordsDisplay() == a.fnRecordsTotal()
            ...
            ? b.sInfoEmpty +
              " " +
              b.sInfoFiltered.replace("_MAX_", l) +
              b.sInfoPostFix
            : a.fnRecordsDisplay() == a.fnRecordsTotal()
            ? b.sInfo
                .replace("_START_", h)
                .replace("_END_", k)
                .replace("_MAX_", l)
                .replace("_TOTAL_", n) + b.sInfoPostFix
            : b.sInfo
                .replace("_START_", h)
                .replace("_END_", k)
                .replace("_MAX_", l)
              ...
              b.sInfoPostFix;
        (b = b.fnInfoCallback) && (h = b.call(a.oInstance, a, e, c, f, g, h));
        e = a.aanFeatures.i;
        if ("undefined" != typeof e)
          for (f = 0, g = e.length; f < g; f++) d(e[f]).html(h);
    ...
    _parseHeight: function (a) {
      ...
      "px" === c
        ...
        ? (b = (a / 100) * d(h).height())
        : "rem" === c
        ? (b = a * parseFloat(d(":root").css("font-size")))
        : "em" === c && (b = a * parseFloat(d("body").css("font-size")));
      return b ? b : 0;
    },
    _scroll: function () {
      var a = this,
      ...
      if (!this.s.skip && !this.s.ingnoreScroll && c !== this.s.lastScrollTop)
        if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;
          ...
          this.s.scrollType =
            Math.abs(c - this.s.lastScrollTop) > b.viewport ? "jump" : "cont";
          this.s.topRowFloat =
            "cont" === this.s.scrollType
              ? this.pixelsToRow(c, !1, !1)
          ...
          if (
            ...
            var f = parseInt(this.s.topRowFloat, 10) - e;
            this.s.forceReposition = !1;
            0 >= f
              ? (f = 0)
              : f + this.s.dt._iDisplayLength > this.s.dt.fnRecordsDisplay()
              ? ((f = this.s.dt.fnRecordsDisplay() - this.s.dt._iDisplayLength),
                0 > f && (f = 0))
              : 0 !== f % 2 && f++;
            f != this.s.dt._iDisplayStart &&
  ...
  g.version = "2.0.0";
  d(k).on("preInit.dt.dtscroller", function (a, b) {
    if ("dt" === a.namespace) {
      a = b.oInit.scroller;
      var c = p.defaults.scroller;
      if (a || c) (c = d.extend({}, a, c)), !1 !== a && new g(b, c);
    }
  });
  d.fn.dataTable.Scroller = g;
  d.fn.DataTable.Scroller = g;
  var l = d.fn.dataTable.Api;
  ...
  g.select.init = function (a) {
    ...
    !0 === c
      ...
      : f.isPlainObject(c) &&
        ...
        (m = !0),
        c.selector !== h && (k = c.selector),
        c.className !== h && (n = c.className));
    a.select.selector(k);
    a.select.items(d);
    a.select.style(e);
    a.select.blurable(l);
    ...
    !m && f(a.table().node()).hasClass("selectable") && a.select.style("os");
  };
  f.each(
    [
